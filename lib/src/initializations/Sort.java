...
public class Sort {
	...
	private static String inputFile = FileNames.dictionaryDirectory + "/Most_Common_100K.txt";
	private static String filteredOutput = FileNames.dictionaryDirectory + "/FilteredWords.txt";
