...
public class Sort {
	...
	private static String inputFile = FileNames.dictionaryPrefix + "/Most_Common_100K.txt";
	private static String filteredOutput = FileNames.dictionaryPrefix + "/FilteredWords.txt";
